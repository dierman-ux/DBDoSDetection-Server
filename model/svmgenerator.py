...
trains a SVM classifier, and saves the model for use
...
REPORT_PATH = os.path.join("./", "classification_report_svm.csv")
...
plt.tight_layout()
plt.savefig(f"confusion_matrix_svm.png")
plt.close()
...
print("[INFO] Model statistics:", row)
