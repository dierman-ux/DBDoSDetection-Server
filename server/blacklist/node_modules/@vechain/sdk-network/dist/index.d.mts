import { ABIEvent, TransactionClause, TransactionBody as TransactionBody$1, VET, VTHO, Revision, Address, HexUInt, BlockId, ClauseOptions, ABIFunction, DeployParams, Hex, Transaction } from '@vechain/sdk-core';
...
declare class TransactionsModule {
     ...
     * @throws {InvalidDataType}
     */
    fillTransactionBody(body: TransactionBody$1): Promise<TransactionBody$1>;
    /**
...
declare abstract class VeChainAbstractSigner implements VeChainSigner {
    protected readonly MESSAGE_PREFIX: Uint8Array;
    /**
     * The provider attached to this Signer (if any).
     */
    provider?: AvailableVeChainProviders;
 ...
 *                 * params[0]: The block hash to get as a hex string.
 */
declare const ethGetUncleCountByBlockHash: (params: unknown[]) => Promise<number>;
 ...
 *                 * params[0]: The block number to get as a hex string or "latest" or "finalized".
 */
declare const ethGetUncleCountByBlockNumber: (params: unknown[]) => Promise<number>;
 ...
 */
declare const txPoolContent: () => Promise<object>;
 ...
 * @returns The transaction pool status
 */
declare const txPoolContentFrom: (params: unknown[]) => Promise<object>;
 ...
 * @returns The transaction pool status
 */
declare const txPoolInspect: () => Promise<object>;
...
type network_AccountData = AccountData;
type network_AccountDetail = AccountDetail;
declare const network_AccountDetail: typeof AccountDetail;
...
declare const network_CHAIN_TAG: typeof CHAIN_TAG;
...
type network_ContractTraceOptions = ContractTraceOptions;
type network_ContractTraceTarget = ContractTraceTarget;
...
type network_DefaultBlock = DefaultBlock;
declare const network_DefaultBlockToRevision: typeof DefaultBlockToRevision;
...
type network_EstimateGasOptions = EstimateGasOptions;
type network_EstimateGasResult = EstimateGasResult;
type network_Event = Event;
...
type network_FeeHistoryOptions = FeeHistoryOptions;
type network_FeeHistoryResponse = FeeHistoryResponse;
type network_FeesPriorityResponse = FeesPriorityResponse;
...
type network_ForkDetector = ForkDetector;
declare const network_ForkDetector: typeof ForkDetector;
...
type network_HttpMethod = HttpMethod;
declare const network_HttpMethod: typeof HttpMethod;
...
type network_RetrieveStorageRange = RetrieveStorageRange;
type network_RetrieveStorageRangeOptions = RetrieveStorageRangeOptions;
type network_SendTransactionResult = SendTransactionResult;
type network_SignTransactionOptions = SignTransactionOptions;
type network_SignTypedDataOptions = SignTypedDataOptions;
type network_SimpleHttpClient = SimpleHttpClient;
declare const network_SimpleHttpClient: typeof SimpleHttpClient;
...
type network_TransactionSimulationEvent = TransactionSimulationEvent;
...
type network_TypedDataDomain = TypedDataDomain;
type network_TypedDataParameter = TypedDataParameter;
...
declare const network_chainTagToChainId: typeof chainTagToChainId;
declare const network_debugFormatter: typeof debugFormatter;
declare const network_debugTraceBlockByHash: typeof debugTraceBlockByHash;
declare const network_debugTraceBlockByNumber: typeof debugTraceBlockByNumber;
...
declare const network_ethRequestAccounts: typeof ethRequestAccounts;
...
declare const network_ethSignTypedDataV4: typeof ethSignTypedDataV4;
...
declare const network_getCachedChainId: typeof getCachedChainId;
declare const network_getCachedChainTag: typeof getCachedChainTag;
...
declare const network_txPoolContent: typeof txPoolContent;
declare const network_txPoolContentFrom: typeof txPoolContentFrom;
declare const network_txPoolInspect: typeof txPoolInspect;
declare const network_txPoolStatus: typeof txPoolStatus;
