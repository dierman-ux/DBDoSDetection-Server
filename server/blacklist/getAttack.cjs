...
var n = process.argv[2] ? Number(process.argv[2]) : 0;
function getAttack() {
    return __awaiter(this, arguments, void 0, function (n) {
        var thorSoloClient, contract, attacks, count;
        if (n === void 0) { n = 0; }
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, contract.read.getAttack(n)];
                case 1:
                    attacks = _a.sent();
                    const ip = attacks[0];
                    const attackType = attacks[1];
                    const timestamp = attacks[2];
                    console.log(`IP: ${ip}`);
...
getAttack(n).catch(console.error);
